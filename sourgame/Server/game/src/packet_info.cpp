...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_DROP_ITEM_SYSTEM, sizeof(TPacketCGDropItemSend), "DropItemInfoSend", false);
#endif
	...
	Set(HEADER_CG_GAYA_SYSTEM, sizeof(TPacketCGGayaSystem), "GayaSystemSend", true);
#endif
	...
	Set(HEADER_CG_REFINE_ELEMENT, sizeof(TPacketCGRefineElement), "RefineElement", false);
#endif
#ifdef ENABLE_6_7_BONUS_NEW_SYSTEM
	Set(HEADER_CG_67_BONUS_NEW, sizeof(TPacketCG67BonusSend), "Bonus67NewSend", true);
#endif
	...
	Set(HEADER_CG_PET_WINDOW_TYPE, sizeof(TPacketCGPetWindowType), "PetWindowType", true);
	Set(HEADER_CG_PET_NAME_CHANGE, sizeof(TPacketCGPetNameChange), "PetNameChange", true);
	Set(HEADER_CG_PET_FEED, sizeof(TPacketCGPetFeed), "PetFeed", true);
	Set(HEADER_CG_PET_DETERMINE, sizeof(TPacketCGPetDetermine), "PetDetermine", true);
	Set(HEADER_CG_PET_ATTR_CHANGE, sizeof(TPacketCGPetAttrChange), "PetAttrChange", true);
	Set(HEADER_CG_PET_REVIVE, sizeof(TPacketCGPetRevive), "PetRevive", true);

	Set(HEADER_CG_PET_LEARN_SKILL, sizeof(TPacketCGPetLearnSkill), "PetLearnSkill", true);
	Set(HEADER_CG_PET_SKILL_UPGRADE, sizeof(TPacketCGPetSkillUpgrade), "PetSkillUpgrade", true);
