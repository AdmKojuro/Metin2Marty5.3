...
ACMD(do_state)
{
	...
	ch->ChatPacket(CHAT_TYPE_INFO, "IMMUN:");
	ch->ChatPacket(CHAT_TYPE_INFO, "   ETOURD.:%d RALENT.:%d CHUTE:%d",
	...
	ch->ChatPacket(CHAT_TYPE_INFO, "   METIN:%3d%% BOSS:%3d%%",
...
typedef enum do_set_types_s {GOLD, RACE, SEX, JOB, EXP, MAX_HP, MAX_SP, SKILL, ALIGNMENT, ALIGN, GAYA, CHEQUE} do_set_types_t;
#else
