...
const DWORD bio_data[][17] = {
	// level, item, count, time, lucky, stone, afftype1, affvalue1, afftype2, affvalue2, afftype3, affvalue3 , afftype4, affvalue4, isChoose
		...
		{ 30, 30006, 10, 600, 60, 30220, POINT_MAX_HP, 10000,0,0,0,0,0,0,0, 71035, 30250},//Dientes orco
		{ 40, 30047, 15, 600, 60, 30221, POINT_MAX_HP, 5000,0,0,0,0,0,0,0, 71035, 30250},//Libro maldicion
		{ 50, 30015, 15, 900, 60, 30222, POINT_ATTBONUS_HUMAN, 12,0,0,0,0,0,0,0, 71035, 30250},//Recuerdo del demonio
		{ 60, 30050, 20, 900, 60, 30223, POINT_CASTING_SPEED, 15,0,0,0,0,0,0,1, 71035, 30250},//Bola de hielo
		{ 70, 30165, 25, 1800, 60, 30224, POINT_ATT_GRADE_BONUS, 30,POINT_ATTBONUS_MONSTER,10,0,0,0,0,1, 71035, 30250},//Ramas Zelkova
		{ 80, 30166, 30, 1800, 60, 30225, POINT_MAX_HP, 1000,POINT_CASTING_SPEED,10,0,0,0,0,1, 71035, 30250},//Panel Tugyis
		{ 85, 30167, 40, 2700, 60, 30226, POINT_RESIST_WARRIOR, 10,POINT_RESIST_ASSASSIN,10,POINT_RESIST_SURA,10,POINT_RESIST_SHAMAN,10,0, 71035, 30250},//Rama arbol Rojo Fantasma
		{ 90, 30168, 50, 3600, 60, 30227, POINT_ATTBONUS_WARRIOR, 10,POINT_ATTBONUS_ASSASSIN,10,POINT_ATTBONUS_SURA,10,POINT_ATTBONUS_SHAMAN,10,0, 71035, 30250},//Notas del Lider
		{ 92, 30251, 10, 7200, 60, 30228, POINT_MAX_HP, 1200,POINT_DEF_GRADE_BONUS,120,POINT_ATT_GRADE_BONUS,50,0,0,1, 71035, 30250},//Joya de la envidia
		{ 94, 30252, 20, 7200, 60, 30229, POINT_MAX_HP, 1500,POINT_DEF_GRADE_BONUS,140,POINT_ATT_GRADE_BONUS,60,0,0,1, 71035, 30250},//Joya de la sabiduria
		{ 98, 300010, 35, 10800, 60, 30230, POINT_ATTBONUS_MONSTER, 10,POINT_RESIST_HUMAN,10,0,0,0,0,1, 71035, 30250},//Pluma Fenix
		{ 100, 300011, 35, 10800, 60, 30231, POINT_ATTBONUS_MONSTER, 10,POINT_MELEE_MAGIC_ATT_BONUS_PER,10,0,0,0,0,1, 71035, 30250},//Monoculo Rojo
		{ 105, 300012, 35, 10800, 60, 30232, POINT_ATT_GRADE_BONUS, 50,POINT_ATTBONUS_HUMAN,10,0,0,0,0,1, 71035, 30250},//Recetas antiguas
};
#endif
 ...
 */
{
	...
	{ POINT_ENCHANT_ELEC, },				// APPLY_ENCHANT_ELEC,				// 99
	...
	{ POINT_RESIST_SWORD_REDUCTION, },		// APPLY_RESIST_SWORD_REDUCTION,	// 108
	{ POINT_RESIST_TWOHAND_REDUCTION, },	// APPLY_RESIST_TWOHAND_REDUCTION,	// 109
	{ POINT_RESIST_DAGGER_REDUCTION, },		// APPLY_RESIST_DAGGER_REDUCTION,	// 110
	{ POINT_RESIST_BELL_REDUCTION, },		// APPLY_RESIST_BELL_REDUCTION,		// 111
	{ POINT_RESIST_FAN_REDUCTION, },		// APPLY_RESIST_FAN_REDUCTION,		// 112
	{ POINT_RESIST_BOW_REDUCTION, },		// APPLY_RESIST_BOW_REDUCTION,		// 113
#ifdef ENABLE_WOLFMAN_CHARACTER
	{ POINT_RESIST_CLAW_REDUCTION, },		// APPLY_RESIST_CLAW_REDUCTION,		// 114
#endif
...
#ifdef __ELEMENT_SYSTEM__
	{ "ENCHANT_ELECT", APPLY_ENCHANT_ELEC },
