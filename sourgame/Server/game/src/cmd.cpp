...
#endif
#ifdef OFFLINE_SHOP
	{ "open_shop",					do_shop_open,						0,	POS_DEAD,	GM_PLAYER },
...
#ifdef ENABLE_OFFSHOP_DECO
	//Shop Decoration
	{ "shop_decoration",		do_shop_decoration,		0,			POS_DEAD,		GM_PLAYER		},
	{ "open_decoration",		do_open_decoration,		0,			POS_DEAD,		GM_PLAYER		},
	//Shop Decoration
#endif
#ifdef ENABLE_WOLFMAN_CHARACTER
...
#endif
#ifdef ENABLE_EXIT_FAST
	{ "exit_fast_client", do_exit_fast, 	0, POS_DEAD,				GM_PLAYER },
#endif
