...
int get_Item_Type_Value(string inputString)
{
	string arType[] = {
		...
		"ITEM_RING",             // 33 ~ 34
		"ITEM_BELT",             // 34 ~ 35? (EItemTypes ??? ?? 34)
#ifdef __ENABLE_CHEQUE_SYSTEM__
		"ITEM_CHEQUE",           // 35 ~ 36 (EItemTypes Value 35)
#endif
		"ITEM_PET",   			// 36 ~ 37 (EItemTypes Value 36)
		"ITEM_MEDIUM",			// 37 ~ 38 (EItemTypes Value 37)
		"ITEM_GACHA", 			// 38 ~ 39 (EItemTypes Value 38)
#ifdef __SOUL_SYSTEM__
		"ITEM_SOUL"   			// 39 ~ 40 (EItemTypes Value 39)
#endif
	};
...
int get_Item_SubType_Value(unsigned int type_value, string inputString)
{
	...
	static string arSub36[] = { "PET_EGG", "PET_UPBRINGING", "PET_BAG", "PET_FEEDSTUFF", "PET_SKILL", "PET_SKILL_DEL_BOOK", "PET_NAME_CHANGE",
								"PET_EXPFOOD", "PET_SKILL_ALL_DEL_BOOK", "PET_EXPFOOD_PER", "PET_ATTR_DETERMINE", "PET_ATTR_CHANGE", "PET_PAY", "PET_PRIMIUM_FEEDSTUFF" };
	...
	static int arNumberOfSubtype[_countof(arSubType)] = {
		...
		0,	// 35
#endif
		sizeof(arSub36)/sizeof(arSub36[0]), // 36
		0, // 37
		0, // 39
#ifdef __SOUL_SYSTEM__
...
{
	string arType[] = { "MONSTER", "NPC", "STONE", "WARP", "DOOR", "BUILDING", "PC", "POLYMORPH_PC", "HORSE", "GOTO", "PET_PAY", "PET"};
