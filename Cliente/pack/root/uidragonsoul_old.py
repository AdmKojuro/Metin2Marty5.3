...
class DragonSoulWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		GetObject("Inventory_Tab_01").ShowToolTip = lambda arg=1: self.OverInButton(arg)
		GetObject("Inventory_Tab_01").HideToolTip = lambda arg=1: self.OverOutButton()
		GetObject("Inventory_Tab_02").ShowToolTip = lambda arg=2: self.OverInButton(arg)
		GetObject("Inventory_Tab_02").HideToolTip = lambda arg=2: self.OverOutButton()
		GetObject("Inventory_Tab_03").ShowToolTip = lambda arg=3: self.OverInButton(arg)
		GetObject("Inventory_Tab_03").HideToolTip = lambda arg=3: self.OverOutButton()
		GetObject("Inventory_Tab_04").ShowToolTip = lambda arg=4: self.OverInButton(arg)
		GetObject("Inventory_Tab_04").HideToolTip = lambda arg=4: self.OverOutButton()
		GetObject("Inventory_Tab_05").ShowToolTip = lambda arg=5: self.OverInButton(arg)
		GetObject("Inventory_Tab_05").HideToolTip = lambda arg=5: self.OverOutButton()
		GetObject("Inventory_Tab_06").ShowToolTip = lambda arg=6: self.OverInButton(arg)
		GetObject("Inventory_Tab_06").HideToolTip = lambda arg=6: self.OverOutButton()

	def OverInButton(self, stat):
		if stat == 1:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.RAW)
			self.toolTip.Show()
		elif stat == 2:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.CHILLED)
			self.toolTip.Show()
		elif stat == 3:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.RARE)
			self.toolTip.Show()
		elif stat == 4:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.ANCIENT)
			self.toolTip.Show()
		elif stat == 5:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.LEGENDARY)
			self.toolTip.Show()
		elif stat == 6:
			self.toolTip.ClearToolTip()
			self.toolTip.AlignHorizonalCenter()
			self.toolTip.AutoAppendNewTextLine(uiScriptLocale.MYTHICAL)
			self.toolTip.Show()
	...
	if app.ENABLE_DRAGON_SOUL_EFFECT:
		def ActivateEquipSlotWindow(self, deck):
			...
			# Pas besoin de blanc car la d?inition de 'i' == blanc par default.
			for i in xrange(6):
				if deck == 2:
					plusCount = 6
				else:
