...
class CharacterDetailsUI(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		# if app.ENABLE_ITEM_POWER_SYSTEM:
			# self.InfoList.append(["Power", "Power", item.GetApplyPoint(player.ITEM_POWER)])
		...
		if app.ENABLE_ATTR_METIN_BOSS:
			self.InfoList.append([localeInfo.DETAILS_80, localeInfo.DETAILS_TOOLTIP_80, item.GetApplyPoint(item.APPLY_ATTBONUS_METIN)])
			self.InfoList.append([localeInfo.DETAILS_81, localeInfo.DETAILS_TOOLTIP_81, item.GetApplyPoint(item.APPLY_ATTBONUS_BOSS)])
		if app.ENABLE_ELEMENT_ADD:
