...
if EMOTION_VERSION == 2:
	...
	if app.ENABLE_EXPRESSING_EMOTION:
		...
		EMOTION_CHARGING : {"name": localeInfo.EMOTION_CHARGING, "command":EMOTICON_NEXT+30},
		EMOTION_NOSAY : {"name": localeInfo.EMOTION_NOSAY, "command":EMOTICON_NEXT+31},
		EMOTION_WEATHER_1 : {"name": localeInfo.EMOTION_WEATHER_1, "command":EMOTICON_NEXT+32},
		EMOTION_WEATHER_2 : {"name": localeInfo.EMOTION_WEATHER_2, "command":EMOTICON_NEXT+33},
		EMOTION_WEATHER_3 : {"name": localeInfo.EMOTION_WEATHER_3, "command":EMOTICON_NEXT+34},
		EMOTION_HUNGRY : {"name": localeInfo.EMOTION_HUNGRY, "command":EMOTICON_NEXT+35},
		EMOTION_SIREN : {"name": localeInfo.EMOTION_SIREN, "command":EMOTICON_NEXT+36},
		EMOTION_ALCOHOL : {"name": localeInfo.EMOTION_ALCOHOL, "command":EMOTICON_NEXT+37},
		EMOTION_CALL : {"name": localeInfo.EMOTION_CALL, "command":EMOTICON_NEXT+38},
		EMOTION_CELEBRATION : {"name": localeInfo.EMOTION_CELEBRATION, "command":EMOTICON_NEXT+39},
		EMOTION_LETTER : {"name": localeInfo.EMOTION_LETTER, "command":EMOTICON_NEXT+40},
		EMOTION_BUSY : {"name": localeInfo.EMOTION_BUSY, "command":EMOTICON_NEXT+41},
		EMOTION_WHIRL : {"name": localeInfo.EMOTION_WHIRL, "command":EMOTICON_NEXT+42},
		}
