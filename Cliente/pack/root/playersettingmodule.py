...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+10, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7_f.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+11, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_8_f.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+12, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_f.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+16, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7_s.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+17, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_8_s.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+18, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_s.mse")

	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+19, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_7.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+20, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_8.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+21, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_9.mse")

	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+22, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-1.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+23, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-2.mse")
	
	if app.ENABLE_LVL115_ARMOR_EFFECT:
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+24, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-5-1.mse")

	if app.ENABLE_ACCE_SYSTEM:
		chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 25, "Bip01", "d:/ymir work/pc/common/effect/armor/acc_01.mse")

	# if app.ENABLE_OFFICIAL_19_3_ITEMS:
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 26, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_7th_01.mse")
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 27, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 28, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th_f.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 29, 'PART_WEAPON_LEFT', 'D:/ymir work/pc/common/effect/sword/sword_7th_b.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 30, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 31, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th_s.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 32, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th_f.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 33, 'PART_WEAPON', 'D:/ymir work/pc/common/effect/sword/sword_7th_w.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 34, 'PART_WEAPON_LEFT', 'D:/ymir work/pc/common/effect/sword/sword_7th_f.mse')
		# chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 35, 'PART_WEAPON_LEFT', 'D:/ymir work/pc/common/effect/sword/sword_7th_w.mse')
	...
	if app.ENABLE_REFINE_ELEMENT:
		...
		for i, elementName in enumerate(("electric", "fire", "ice", "wind", "daeji", "dark")):
			for j, weaponType in enumerate(("", "b", "f", "f_1", "s", "s_l", "w", "w_l")):
				effectName = "element%02d_%s" % (i + 1, elementName)
				effectName += (".mse") if weaponType == "" else (("_%s.mse" % weaponType[:1]) if weaponType in ("f_1", "s_l", "w_l") else ("_%s.mse" % weaponType))
				
				effectNumber = (i * chrmgr.EFFECT_REFINE_ELEMENT_WEAPON_MAX) + j
				if weaponType in ("b", "f_1", "s_l", "w_l"):
