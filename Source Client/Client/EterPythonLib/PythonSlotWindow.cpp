...
void CSlotWindow::ActivateSlot(DWORD dwIndex)
{
	...
	int itemSize = pSlot->byyPlacedItemSize - 1;
	if (itemSize < 0)
	{
		itemSize = 1;
	}
...
void CSlotWindow::OnRender()
{
	...
	for (itor = m_SlotList.begin(); itor != m_SlotList.end(); ++itor)
	{
		...
		{
#ifdef WJ_ENABLE_PICKUP_ITEM_EFFECT
			WORD slotSize = max(0, rSlot.byyPlacedItemSize - 1);
...
#endif
{
	...
	if (activeSlot == 1)
	{
		...
		m_pSlotActiveEffect[1] = new CAniImageBox(NULL);
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/00.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/01.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/02.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/03.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/04.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/05.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/06.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/07.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/08.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/09.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/10.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/11.sub");
		m_pSlotActiveEffect[1]->AppendImage("d:/ymir work/ui/public/slotactiveeffect/slot2/12.sub");
	}
	else if (activeSlot == 2)
	{
		__DestroySlotEnableEffect(activeSlot);

		m_pSlotActiveEffect[2] = new CAniImageBox(NULL);
	...
	else
	{
		...
		m_pSlotActiveEffect[activeSlot] = new CAniImageBox(NULL);
	...
	m_pSlotActiveEffect[activeSlot]->SetRenderingMode(CGraphicExpandedImageInstance::RENDERING_MODE_SCREEN);
...
#endif
{
	...
	if (m_pSlotActiveEffect[activeSlot])
	{
		...
		m_pSlotActiveEffect[activeSlot] = NULL;
	}
#else
	if (m_pSlotActiveEffect)
	{
...
void CSlotWindow::__Initialize()
{
	...
	m_pToggleSlotImage = NULL;
#ifdef WJ_ENABLE_PICKUP_ITEM_EFFECT
	m_pSlotActiveEffect[0] = NULL;
	m_pSlotActiveEffect[1] = NULL;
	m_pSlotActiveEffect[2] = NULL;
#else
	m_pSlotActiveEffect = NULL;
#endif
	m_pBaseImageInstance = NULL;
