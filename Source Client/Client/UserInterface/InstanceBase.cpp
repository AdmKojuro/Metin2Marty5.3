...
#ifdef ENABLE_REFINE_ELEMENT
	if (m_swordRefineElementEffectRight)
	{
		__DetachEffect(m_swordRefineElementEffectRight);
		m_swordRefineElementEffectRight = 0;
	}
	if (m_swordRefineElementEffectLeft)
	{
		__DetachEffect(m_swordRefineElementEffectLeft);
		m_swordRefineElementEffectLeft = 0;
	}	
#endif
}
...
{
//#if defined(ENABLE_SIMPLE_REFINED_EFFECT_CHECK) && defined(ENABLE_REFINE_ELEMENT)
			...
			if(bRefineElement) 
			{
				...
				switch(pItem->GetSubType())
				{
					case CItemData::WEAPON_DAGGER:
						m_swordRefineElementEffectRight = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_DAGGER);
						m_swordRefineElementEffectLeft = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_DAGGER_LEFT);
						m_swordRefineEffectRight = EFFECT_REFINED+EFFECT_SMALLSWORD_REFINED7+refine-7;
						m_swordRefineEffectLeft = EFFECT_REFINED+EFFECT_SMALLSWORD_REFINED7_LEFT+refine-7;					
						if (vnum >= 1200 && vnum <= 1205 ||
							vnum >= 1220 && vnum <= 1225 )
						{
							m_swordRefineEffectRight = EFFECT_REFINED+EFFECT_WEAPON_DAGGER_SPECIAL_19_3; //BIÇAK
							m_swordRefineEffectLeft = EFFECT_REFINED+EFFECT_WEAPON_DAGGER_SPECIAL_19_3_LEFT; //BIÇAK
						}
						break;
						
					case CItemData::WEAPON_FAN:
						m_swordRefineElementEffectRight = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_FAN);
						if (m_kHorse.IsMounting()){
							m_swordRefineElementEffectLeft = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_FAN_LEFT);
							m_swordRefineEffectLeft = EFFECT_REFINED + EFFECT_FANBELL_REFINED7_LEFT + refine - 7;
						}
					...
					case CItemData::WEAPON_BELL:
						...
						if (vnum >= 5180 && vnum <= 5185 ||
							vnum >= 5210 && vnum <= 5215)
						{
							m_swordRefineEffectRight = EFFECT_REFINED+EFFECT_WEAPON_BELL_SPECIAL_19_3; //ÇAN
						}
						break;
					case CItemData::WEAPON_BOW:
						m_swordRefineElementEffectRight = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_BOW);
					...
					case CItemData::WEAPON_CLAW:
						m_swordRefineElementEffectRight = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_CLAW);
						m_swordRefineElementEffectLeft = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_CLAW_LEFT);
						m_swordRefineEffectRight = EFFECT_REFINED + EFFECT_SMALLSWORD_REFINED7 + refine - 7;
						m_swordRefineEffectLeft = EFFECT_REFINED + EFFECT_SMALLSWORD_REFINED7_LEFT + refine - 7;
						if (vnum >= 6140 && vnum <= 6145 ||
							vnum >= 6160 && vnum <= 6165 )
						{
							m_swordRefineEffectRight = EFFECT_REFINED+EFFECT_WEAPON_CLAW_SPECIAL_19_3;
							m_swordRefineEffectLeft = EFFECT_REFINED+EFFECT_WEAPON_CLAW_SPECIAL_19_3_LEFT;
						}
						break;
#endif
					default:
						m_swordRefineElementEffectRight = EFFECT_REFINE_ELEMENT + ((bRealRefineElement * EFFECT_REFINE_ELEMENT_WEAPON_MAX) + EFFECT_REFINE_ELEMENT_WEAPON_SWORD);
						...
						if (vnum >= 330 && vnum <= 335 || 
							...
							vnum >= 3260 && vnum <= 3265 )
						{
							m_swordRefineEffectRight = EFFECT_REFINED+EFFECT_WEAPON_TWO_HANDED_SPECIAL_19_3;
						}
						break;
				}
...
#ifdef ENABLE_REFINE_ELEMENT
			if (m_swordRefineElementEffectRight)
				m_swordRefineElementEffectRight = __AttachEffect(m_swordRefineElementEffectRight);
				
			if (m_swordRefineElementEffectLeft)
				m_swordRefineElementEffectLeft = __AttachEffect(m_swordRefineElementEffectLeft);
#endif			
			break;
