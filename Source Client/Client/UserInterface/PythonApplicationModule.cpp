...
void initapp()
{
...
#ifdef IMAGE_SCALE
	PyModule_AddIntConstant(poModule, "IMAGE_SCALE", 1);
#else
	PyModule_AddIntConstant(poModule, "IMAGE_SCALE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ENVIRONMENT_OPTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ENVIRONMENT_OPTION", 0);
#endif

#if defined(__BL_LOADING_TIP__)
	PyModule_AddIntConstant(poModule, "__BL_LOADING_TIP__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_LOADING_TIP__", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_DROP_DIALOG", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_DROP_DIALOG", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "__ENABLE_CHEQUE_OFFLINE_SHOP__", 1);
#else
	PyModule_AddIntConstant(poModule, "__ENABLE_CHEQUE_OFFLINE_SHOP__", 0);
#endif 

#ifdef PYTHON_MOUSEWHEEL_RENEWAL
		PyModule_AddIntConstant(poModule, "ENABLE_PYTHON_MOUSEWHEEL_RENEWAL", 1);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ATTR_METIN_BOSS", true);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ATTR_METIN_BOSS", false);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_OFFSHOP_DECO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OFFSHOP_DECO", 0);
#endif
...
#else
		PyModule_AddIntConstant(poModule, "ENABLE_CUBE_RENEWAL_COPY_WORLDARD",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXIT_FAST", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXIT_FAST", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ANTIFLAG_TOOLTIP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ANTIFLAG_TOOLTIP", 0);
#endif
...
#ifdef ENABLE_GOOGLE_TRANSLATE_INGAME
	PyModule_AddIntConstant(poModule, "ENABLE_GOOGLE_TRANSLATE_INGAME", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GOOGLE_TRANSLATE_INGAME", 0);
#endif
...
#ifdef ENABLE_INVENTORY_SIDEBAR
	PyModule_AddIntConstant(poModule, "ENABLE_INVENTORY_SIDEBAR", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INVENTORY_SIDEBAR", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SEARCH_ITEM_DROP_ON_MOB", 1);
#else
