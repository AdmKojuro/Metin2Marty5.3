...
void CPythonPlayer::Clear()
{
	...
	{
		TItemData2& rkAuraItemInstance = m_AuraItemInstanceVector[i];
		ZeroMemory(&rkAuraItemInstance, sizeof(TItemData2));
	}
...
void CPythonPlayer::SetAuraItemData(BYTE bySlotIndex, const TItemData2& rItemInstance)
{
...
void CPythonPlayer::DelAuraItemData(BYTE bySlotIndex)
{
	...
	TItemData2& rInstance = m_AuraItemInstanceVector[bySlotIndex];
	CItemData* pItemData;
	if (CItemManager::instance().GetItemDataPointer(rInstance.vnum, &pItemData))
	{
		...
		ZeroMemory(&rInstance, sizeof(TItemData2));
	}
}
...
BOOL CPythonPlayer::GetAuraItemDataPtr(BYTE bySlotIndex, TItemData2** ppInstance)
{
	if (bySlotIndex >= m_AuraItemInstanceVector.size())
	{
