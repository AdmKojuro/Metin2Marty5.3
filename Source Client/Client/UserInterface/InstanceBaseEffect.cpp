...
void CInstanceBase::__AttachEmpireEffect(DWORD eEmpire)
{
	...
	if (IsResource())
		return;
#ifdef ENABLE_KINGDOMS_FLAG_DELETE
	if (IsNPC())
		return;
#endif
...
UINT CInstanceBase::GetNameColorIndex()
{
	...
	{
#ifdef ENABLE_OFFLINE_SHOP
		if ((GetRace() == 30000) || (GetRace() == 30001) || (GetRace() == 30002) || (GetRace() == 30003) || (GetRace() == 30004) || (GetRace() == 30005) || (GetRace() == 30006) || (GetRace() == 30007))
		{
			return NAMECOLOR_SHOP;
		}
		else
