...
// #ifdef ENABLE_OFFLINE_SHOP
		// else if ((pkInstEach->GetRace()==30000) || (pkInstEach->GetRace()==30001) || (pkInstEach->GetRace()==30002) || (pkInstEach->GetRace()==30003) || (pkInstEach->GetRace()==30004) || (pkInstEach->GetRace()==30005) || (pkInstEach->GetRace()==30006) || (pkInstEach->GetRace()==30007))
		// {
			// aMarkPosition.m_fX = ( m_fWidth - (float)m_WhiteMark.GetWidth() ) / 2.0f + fDistanceFromCenterX + m_fScreenX;
			// aMarkPosition.m_fY = ( m_fHeight - (float)m_WhiteMark.GetHeight() ) / 2.0f + fDistanceFromCenterY + m_fScreenY;
			// aMarkPosition.m_eNameColor=pkInstEach->GetNameColorIndex();
...
#ifdef ENABLE_OFFLINE_SHOP
			if ((pkInstEach->GetRace()==30000) || (pkInstEach->GetRace()==30001) || (pkInstEach->GetRace()==30002) || (pkInstEach->GetRace()==30003) || (pkInstEach->GetRace()==30004) || (pkInstEach->GetRace()==30005) || (pkInstEach->GetRace()==30006) || (pkInstEach->GetRace()==30007))
