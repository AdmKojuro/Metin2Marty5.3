...
#define ENABLE_INBUILT_ANIMATION								//Animacion GR2 ACCE, ESTOLAS, ARMAS ETC
...
#define PYTHON_MOUSEWHEEL_RENEWAL
...
#endif
//#define ENABLE_GOOGLE_TRANSLATE_INGAME
#define ENABLE_ELEMENT_ADD // Monsters element
#define ENABLE_PENDANT // Talismans of elements
#define ENABLE_FUNTION_EXTRA_TARGET // extra functions for the target
...
#define ENABLE_ENVIRONMENT_OPTION	// Enable environment options
...
#define ENABLE_NEW_SOUL_FUNCTION
#define __BL_LOADING_TIP__
#define ENABLE_DUNGEON_INFO_SYSTEM // Dungeon Information System owsap v2
#define ENABLE_SPECIAL_INVENTORY_SYSTEM
#define ENABLE_SORT_INVENTORY /// < Sort Inventory
/* System Enable */

/* Official System */
#define ENABLE_REFINE_ELEMENT
#define ENABLE_ATTR_METIN_BOSS // New attr metin & boss
#define ENABLE_OFFICIAL_19_3_ITEMS
/* Official System */
...
#define ENABLE_KINGDOMS_FLAG_DELETE // Flag on name
