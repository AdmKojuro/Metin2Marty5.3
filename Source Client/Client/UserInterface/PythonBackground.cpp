...
const char * CPythonBackground::GetMapName()
{
	...
	if (c_rstrMapFileName == "metin2_map_a1")
		...
		return "Bakra";
	else if (c_rstrMapFileName == "map_a2")
		return "Valle de Seungryong";
	else if (c_rstrMapFileName == "map_n_snowm_01")
		return "Montaña Sohan";
	else if (c_rstrMapFileName == "metin2_map_deviltower1")
		return "Torre Demonios";
	else if (c_rstrMapFileName == "metin2_map_milgyo")
		return "Temple Hwang";
	else if (c_rstrMapFileName == "metin2_map_n_desert_01")
		return "Desierto de Yongbi";
	else if (c_rstrMapFileName == "metin2_map_n_flame_01")
		return "Tierra de Fuego";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon")
		return "Cueva Arañas 1";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon_02")
		return "Cueva Arañas 2";
	else if (c_rstrMapFileName == "metin2_map_spiderdungeon_03")
		return "Cueva Arañas3";
	else if (c_rstrMapFileName == "metin2_map_oxevent")
		return "Evennt - OX";
	else if (c_rstrMapFileName == "metin2_map_devilsCatacomb")
		return "Catatumbas del Diablo";
		...
		return "Gruta de Exilio 1";
	else if (c_rstrMapFileName == "metin2_map_skipia_dungeon_02")
		return "Gruta de Exilio 2";
	else if (c_rstrMapFileName == "metin2_map_skipia_dungeon_boss")
		return "Sala del Dragon";
	//etc
	else
		return "-";
}
