...
PyObject* itemGetApplyPoint(PyObject* poSelf, PyObject* poArgs)
{
	...
	static const std::unordered_map<BYTE, BYTE> PointMap
	{
		...
		{ CItemData::APPLY_RESIST_SURA, POINT_RESIST_ASSASSIN },
		...
		{ CItemData::APPLY_RESIST_SWORD_REDUCTION, POINT_RESIST_SWORD_REDUCTION },
		{ CItemData::APPLY_RESIST_TWOHAND_REDUCTION, POINT_RESIST_TWOHAND_REDUCTION },
		{ CItemData::APPLY_RESIST_DAGGER_REDUCTION, POINT_RESIST_DAGGER_REDUCTION },
		{ CItemData::APPLY_RESIST_BELL_REDUCTION, POINT_RESIST_BELL_REDUCTION },
		{ CItemData::APPLY_RESIST_FAN_REDUCTION, POINT_RESIST_FAN_REDUCTION },
		{ CItemData::APPLY_RESIST_BOW_REDUCTION, POINT_RESIST_BOW_REDUCTION },
#ifdef ENABLE_WOLFMAN_CHARACTER
		{ CItemData::APPLY_RESIST_CLAW_REDUCTION, POINT_RESIST_CLAW_REDUCTION },
#endif
		{ CItemData::APPLY_RESIST_HUMAN, POINT_RESIST_HUMAN },
#ifdef ENABLE_ATTR_METIN_BOSS
		{ CItemData::APPLY_ATTBONUS_METIN, POINT_ATTBONUS_METIN },
...
#ifdef ENABLE_WOLFMAN_CHARACTER
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_CLAW_REDUCTION", CItemData::APPLY_RESIST_CLAW_REDUCTION);
#endif
